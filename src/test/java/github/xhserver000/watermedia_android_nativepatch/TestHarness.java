...
public final class TestHarness {
    ...
    public static void main(final String... args) throws Exception {
        ...
        assertTrue(WaterMediaAndroidNativePatchModTest.matches("libstdc++.so.6"), "libstdc++.so.6");
        assertTrue(WaterMediaAndroidNativePatchModTest.matches("libfoo.so.1.2.3"), "libfoo.so.1.2.3");
        assertTrue(!WaterMediaAndroidNativePatchModTest.matches("libfoo.jar"), "libfoo.jar");

        System.out.println("== bionic detection ==");
        System.out.println("  isBionic = " + WaterMediaAndroidNativePatchMod.isBionic());
        ...
        assertTrue(WaterMediaAndroidNativePatchModTest.isLoaded("libstdc++.so.6"), "libstdc++ actually loaded (non-bionic host)");

        final int n2 = WaterMediaAndroidNativePatchMod.process(runtimeDir, userDir);
