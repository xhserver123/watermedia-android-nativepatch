...
1. Download the latest jar from the
   [Releases](https://github.com/xhserver123/watermedia-nativepatch/releases) page.
2. Put `watermedia-nativepatch-1.0.0.jar` into your `mods/` folder.
3. Launch the game.
...
```bash
./build.sh
# output: release/watermedia-nativepatch-1.0.0.jar
```
